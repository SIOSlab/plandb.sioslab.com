...
if cache:
    ...
    if photdict_path.exists():
        ...
        photdict = loadPhotometryData(infile="allphotdata_2015.npz")
...
if cache:
    ...
    if ephemeris_orbfits_path.exists():
        ...
        ephemeris_orbitfits, ephemeris_orbdata = addEphemeris(
            data, orbitfits, orbdata, bandzip, photdict
        )
...
if cache:
    ...
    if comps_path.exists():
        ...
        comps, compdict, comps_data = calcPlanetCompleteness(
            contr_data, bandzip, photdict, exosims_json=exosims_json
        )
