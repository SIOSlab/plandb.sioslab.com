...
def updateDatabase():
  ...
  sios_engine = create_engine('mysql+pymysql://'+"andrewchiu"+':'+password+'@localhost/testBeforeUpdate',echo=True)
  diff_sios_engine = create_engine('mysql+pymysql://'+"andrewchiu"+':'+password+'@localhost/testSiosDiffEngine',echo=True)
  new_engine = create_engine('mysql+pymysql://'+"andrewchiu"+':'+password+'@localhost/testAfterUpdate',echo=True)
