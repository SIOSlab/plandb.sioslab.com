...
if ($result){
    if ($result->num_rows > 0) {
        ...
        echo "<th>Name</th><th>Priority</th><th>&Sigma; DoS(R &lt; R<sub>Nep</sub>)<th>Dist (pc)</th><th>V mag</th><th>DoS</th>";
        echo "</tr></thead>\n";
